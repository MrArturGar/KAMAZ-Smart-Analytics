...
namespace KSA_Collector.Controllers
{
    internal class ApiController : IDisposable
    {
        ...
        private void Auth()
        {
            ...
            urlBuilder_.Append(_client.BaseUrl != null ? _client.BaseUrl.TrimEnd('/') : "").Append("/Auth/Auth");
        ...
        internal bool SessionExistenceByName(string sessionName)
        {
            Task<Session> session = _client.GetSessionByNameAsync(sessionName);
            session.Wait();
